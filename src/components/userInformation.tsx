            ...
            <div className="section">
                ...
                <div className="section-contents">
                    <div>
                        ...
                        <div className="item-value">Grace Effiom</div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="item-value">grace@gmail.com</div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="item-value">Female</div>
                    </div>
                    <div>
                        <div className="item-name">Address</div>
                        <div className="item-value">O'Hara Centers</div>
                    </div>
                </div>
            ...
            <div className="section">
                ...
                <div className="section-contents">
                    ...
                    <div>
                        ...
                        <div className="item-value">₦200,000.00- ₦400,000.00</div>
                    </div>
                </div>
                <div className="base-line"></div>
            </div>
